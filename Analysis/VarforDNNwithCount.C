...
int Calculator::yieldCalc(TChain* signal, TString outFileName, bool isSignal) {
  ...
  double d0el, d0mu,
    ...
    wtelCMS, wtmuCMS, wtelF, wtmuF, wtelN, wtmuN, wtelK, wtmuK;
  ...
  varTree->Branch("wtelK", &wtelK);
  varTree->Branch("wtmuK", &wtmuK);
  auto varTree_SR1 = new TTree("varTree_SR1", "Input Variables List for Algorithms SR1");
  varTree_SR1->Branch("D0El_SR1", &d0el);
  varTree_SR1->Branch("D0Mu_SR1", &d0mu);
  varTree_SR1->Branch("HtJet_SR1", &HtJet);
  varTree_SR1->Branch("dRLL_SR1", &dRLL);
  varTree_SR1->Branch("dPhiLepMETSelObj_SR1", &dPhiLepMETSelObj);
  varTree_SR1->Branch("YDelpObj_SR1", &YDelpObj);
  varTree_SR1->Branch("YUserObj_SR1", &YUserObj);
  varTree_SR1->Branch("alphaT_SR1", &alphaT);
  varTree_SR1->Branch("Sphericity_SR1", &Sphericity);
  varTree_SR1->Branch("Spherocity_SR1", &Spherocity);
  varTree_SR1->Branch("MtLeadLepMET_SR1", &MtLeadLepMET);
  varTree_SR1->Branch("wtelCMS_SR1", &wtelCMS);
  varTree_SR1->Branch("wtmuCMS_SR1", &wtmuCMS);
  varTree_SR1->Branch("wtelF_SR1", &wtelF);
  varTree_SR1->Branch("wtmuF_SR1", &wtmuF);
  varTree_SR1->Branch("wtelN_SR1", &wtelN);
  varTree_SR1->Branch("wtmuN_SR1", &wtmuN);
  varTree_SR1->Branch("wtelK_SR1", &wtelK);
  varTree_SR1->Branch("wtmuK_SR1", &wtmuK);
  auto varTree_SR2 = new TTree("varTree_SR2", "Input Variables List for Algorithms SR2");
  varTree_SR2->Branch("D0El_SR2", &d0el);
  varTree_SR2->Branch("D0Mu_SR2", &d0mu);
  varTree_SR2->Branch("HtJet_SR2", &HtJet);
  varTree_SR2->Branch("dRLL_SR2", &dRLL);
  varTree_SR2->Branch("dPhiLepMETSelObj_SR2", &dPhiLepMETSelObj);
  varTree_SR2->Branch("YDelpObj_SR2", &YDelpObj);
  varTree_SR2->Branch("YUserObj_SR2", &YUserObj);
  varTree_SR2->Branch("alphaT_SR2", &alphaT);
  varTree_SR2->Branch("Sphericity_SR2", &Sphericity);
  varTree_SR2->Branch("Spherocity_SR2", &Spherocity);
  varTree_SR2->Branch("MtLeadLepMET_SR2", &MtLeadLepMET);
  varTree_SR2->Branch("wtelCMS_SR2", &wtelCMS);
  varTree_SR2->Branch("wtmuCMS_SR2", &wtmuCMS);
  varTree_SR2->Branch("wtelF_SR2", &wtelF);
  varTree_SR2->Branch("wtmuF_SR2", &wtmuF);
  varTree_SR2->Branch("wtelN_SR2", &wtelN);
  varTree_SR2->Branch("wtmuN_SR2", &wtmuN);
  varTree_SR2->Branch("wtelK_SR2", &wtelK);
  varTree_SR2->Branch("wtmuK_SR2", &wtmuK);
  auto varTree_SR3 = new TTree("varTree_SR3", "Input Variables List for Algorithms SR3");
  varTree_SR3->Branch("D0El_SR3", &d0el);
  varTree_SR3->Branch("D0Mu_SR3", &d0mu);
  varTree_SR3->Branch("HtJet_SR3", &HtJet);
  varTree_SR3->Branch("dRLL_SR3", &dRLL);
  varTree_SR3->Branch("dPhiLepMETSelObj_SR3", &dPhiLepMETSelObj);
  varTree_SR3->Branch("YDelpObj_SR3", &YDelpObj);
  varTree_SR3->Branch("YUserObj_SR3", &YUserObj);
  varTree_SR3->Branch("alphaT_SR3", &alphaT);
  varTree_SR3->Branch("Sphericity_SR3", &Sphericity);
  varTree_SR3->Branch("Spherocity_SR3", &Spherocity);
  varTree_SR3->Branch("MtLeadLepMET_SR3", &MtLeadLepMET);
  varTree_SR3->Branch("wtelCMS_SR3", &wtelCMS);
  varTree_SR3->Branch("wtmuCMS_SR3", &wtmuCMS);
  varTree_SR3->Branch("wtelF_SR3", &wtelF);
  varTree_SR3->Branch("wtmuF_SR3", &wtmuF);
  varTree_SR3->Branch("wtelN_SR3", &wtelN);
  varTree_SR3->Branch("wtmuN_SR3", &wtmuN);
  varTree_SR3->Branch("wtelK_SR3", &wtelK);
  varTree_SR3->Branch("wtmuK_SR3", &wtmuK);
